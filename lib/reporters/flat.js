...
module.exports = inherit({
    __constructor: function() {
        ...
        ['attachRunner', '_onTestPass', '_onTestFail', '_onRetry', '_logError', '_onTestPending', '_onRunnerEnd',
        '_onWarning', '_onError', '_onInfo', '_formatTestInfo', '_compile', '_getTestName'].forEach(function(methodName) {
            this[methodName] = this._wrap(this[methodName]);
        }.bind(this));
    },
    ...
    _onRunnerEnd: function() {
        console.log('on runner end, flat');
